...
const Part4 = () => {
    return <Page header="เป้าหมายสัดส่วนรายได้ของ อปท. ปี 2561">
        ...
        <div>
            <p>
            ฐานข้อมูลภาครัฐของสำนักงานเศรษฐกิจการคลัง เปิดเผยเป้าหมายสัดส่วนรายได้ของ อปท.2561 ไว้ใน 4 หมวดหมู่  โดยบทความเรื่อง บทบาทของรัฐบาลท้องถิ่นกับการพัฒนาเศรษฐกิจแบบมีส่วนร่วม เขียนโดย คณิณ พีระวัฒนชาติ และธนาคารแห่งประเทศไทย <Reference color="red" url="dummy.com"/> ชี้ให้เห็นว่ากฎหมายจัดตั้งส่วนท้องถิ่นแต่ละประเภทและระเบียบกระทรวงมหาดไทยฯ พ.ศ. 2547 ได้ระบุอำนาจหน้าที่ที่ อปท. สามารถทำได้ ซึ่งแม้กฎหมายจะกำหนดให้ครอบคลุมมิติการพัฒนารอบด้าน 
            </p>
            <p>
